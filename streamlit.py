...
resting_bp = st.number_input("Resting Blood Pressure",min_value = 0, max_value = 200, value = 45)
cholosterol = st.number_input("Cholesterol",min_value = 0, max_value = 500, value = 230)
